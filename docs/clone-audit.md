...
| `BLEED-HAZARD` | Stale directories/files (semanticdb, auto-save-list, .DS_Store, emacs .cache) or legacy hostnames/private IPs. | Inspect the file path and content. | Clean up HEAD/history; do not commit/push private network info. |
